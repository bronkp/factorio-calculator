import { Flex,Link,Show,Text, VStack } from "@chakra-ui/react";
...
<Flex display={{base:'none', md:'flex'}} width='100%' bgColor='orange.400' p={5} position='fixed' bottom={0}  justifyContent="center">
    <VStack mt='auto'>
