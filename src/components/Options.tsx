    ...
    <>
      ...
      >
       Debug
        ...
        {startNew && (
          <NewRecipe setView={setView} setProducts={setProducts} setStartNew={setStartNew} />
        )}
        {!startNew &&<Flex justifyContent='center'> <SavedRecipe key={Date.now()} setProducts={setProducts} startNew={setStartNew} product={view[0]} recipeIndex={view[1]} /></Flex>}
